...
#Config: {
	...
	// The healthcheck allows setting the container liveness and readiness probes.
	healthcheck: {
		livenessProbe?:  corev1.#Probe
		readinessProbe?: corev1.#Probe
	}

	// The env allows setting the container environment variables.
	env: [...corev1.#EnvVar]
	...
	// The ingress allows setting the Kubernetes Ingress.
